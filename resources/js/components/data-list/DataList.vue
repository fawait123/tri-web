...
<template>
    <div
        class="mt-10 relative sm:pb-12 sm:ml-[calc(2rem+1px)] md:ml-[calc(3.5rem+1px)] lg:ml-[max(calc(14.5rem+1px),calc(100%-48rem))]">
        <div
            ...
            <article class="relative group">
                ...
                <div class="relative">
                    <h3 class="text-base font-semibold tracking-tight text-slate-900 dark:text-slate-200 pt-8 lg:pt-0">
                        Radiant: A beautiful new marketing site template</h3>
                    <div class="mt-2 mb-4 prose prose-slate prose-a:relative prose-a:z-10 dark:prose-dark line-clamp-2">
                        <p>Over the past couple of months we’ve been working away at a new SaaS marketing site template
                            for Tailwind UI. It’s called <a href="https://tailwindui.com/templates/radiant">Radiant</a>,
                            and you can start using it today.</p>
                    </div>
                    <dl class="absolute left-0 top-0 lg:left-auto lg:right-full lg:mr-[calc(6.5rem+1px)]">
                        ...
                        <dd class="whitespace-nowrap text-sm leading-6 dark:text-slate-400"><time
                                datetime="2024-09-12T10:30:00.000Z">September 12, 2024</time></dd>
                    </dl>
                </div><a class="flex items-center text-sm text-sky-500 font-medium"
                    href="/blog/2024-09-12-radiant-a-beautiful-new-marketing-site-template"><span
                        class="absolute -inset-y-2.5 -inset-x-4 md:-inset-y-4 md:-inset-x-6 sm:rounded-2xl"></span><span
                        class="relative">Read more<span class="sr-only">, Radiant: A beautiful new marketing site
