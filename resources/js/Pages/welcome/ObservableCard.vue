...
import { observasiListOne } from '@/constant'
import {
    Table,
    TableBody,
    TableCell,
    ...
    <div class="w-[50vw] mt-10">
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    <span class="block mb-2">Berilah tandaceklis(√)pada kolom jawaban dibawah yang dianggap paling
            ...
            <CardContent>
                <Table>
                    ...
                    <TableBody>
                        <TableRow v-for="(item, index) in observasiListOne" :key="item.list">
